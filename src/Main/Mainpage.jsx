...
const Mainpage = () => {
  return (
    <div className=" h-screen pt-3 px-1 z-10 relative">
      <div className="container grid lg:grid-cols-2 gap-2 md:grid-cols-2 sm:grid-cols-1 cus2">
        <h1 className="bg-red-400 rounded-md text-white text-lg p-5 text-center cus col-span-4">
          HelLo World
        </h1>
